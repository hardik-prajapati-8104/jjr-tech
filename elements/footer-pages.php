        ...
        <div class="contact-info-area">
            ...
            <div class="contact-info-items wow fadeInUp" data-wow-delay=".7s">
                ...
                <div class="content">
                    <p>Address</p>
                    <h3>
                        <?= htmlspecialchars($site['contact']['address']); ?>
                    </h3>
                </div>
            </div>
            ...
            <div class="footer-layout style1">
                ...
                <div class="row">
                            ...
                            <div class="gt-widget-about">
                                ...
                                <div class="gt-social style2">
                                    ...
                                    <?php if (!empty($site['social']['twitter'])): ?>
                                        ...
                                        <a href="<?= htmlspecialchars($site['social']['twitter']); ?>"
                                           target="_blank"
                                           rel="noopener noreferrer">
                    ...
                    <div class="col-xl-2 col-md-6 col-12">
                        ...
                        <div class="widget widget_nav_menu footer-widget wow fadeInUp"
                             data-wow-delay="1s">
                            ...
                            <div class="checklist style2">
                                ...
                                <ul class="ps-0">
                                    ...
                                    <li class="text-white">
                                        ...
                                        <a href="mailto:<?= htmlspecialchars($site['contact']['email']); ?>" class="text-white">
                                            <?= htmlspecialchars($site['contact']['email']); ?>
                                        </a>
                                ...
                                <ul class="ps-0">
                                    ...
                                    <li class="text-white">
                                        ...
                                        <a href="tel:<?= htmlspecialchars($site['contact']['phone']); ?>" class="text-white">
                                            <?= htmlspecialchars($site['contact']['phone']); ?>
                                        </a>
